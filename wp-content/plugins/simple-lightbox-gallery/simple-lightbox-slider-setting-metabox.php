...
<table class="form-table">
    ...
    <tr>
         <th scope="row"><label><?php esc_html_e( 'Gallery Title Color', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></label></th>
        <td>
        ...
        <td>
            <select name="wl-font-style" class="standard-dropdown" id="wl-font-style">
                <optgroup label="Default Fonts">
                    <option value="<?php echo esc_attr('Arial'); ?>" <?php selected( $SLGF_Font_Style, 'Arial' ); ?>><?php esc_html_e( 'Arial', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('Arial Black'); ?>" <?php selected( $SLGF_Font_Style, 'Arial Black' ); ?>><?php esc_html_e( 'Arial Black', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?>
                    </option>
                    <option value="<?php echo esc_attr('Courier New'); ?>" <?php selected( $SLGF_Font_Style, 'Courier New' ); ?>><?php esc_html_e( 'Courier New', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?>
                    </option>
                    <option value="<?php echo esc_attr('cursive'); ?>" <?php selected( $SLGF_Font_Style, 'cursive' ); ?>><?php esc_html_e( 'Cursive', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('fantasy'); ?>" <?php selected( $SLGF_Font_Style, 'fantasy' ); ?>><?php esc_html_e( 'Fantasy', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('Georgia'); ?>" <?php selected( $SLGF_Font_Style, 'Georgia' ); ?>><?php esc_html_e( 'Georgia', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('rande'); ?>"<?php selected( $SLGF_Font_Style, 'Grande' ); ?>><?php esc_html_e( 'Grande', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    ...
                    <option value="<?php echo esc_attr('Impact'); ?>" <?php selected( $SLGF_Font_Style, 'Impact' ); ?>><?php esc_html_e( 'Impact', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('Lucida'); ?>" <?php selected( $SLGF_Font_Style, 'Lucida' ); ?>><?php esc_html_e( 'Lucida', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    ...
                    <option value="<?php echo esc_attr('monospace'); ?>" <?php selected( $SLGF_Font_Style, 'monospace' ); ?>><?php esc_html_e( 'Monospace', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('Open Sans'); ?>" <?php selected( $SLGF_Font_Style, 'Open Sans' ); ?>><?php esc_html_e( 'Open Sans', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('Palatino'); ?>" <?php selected( $SLGF_Font_Style, 'Palatino' ); ?>><?php esc_html_e( 'Palatino', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('sans'); ?>" <?php selected( $SLGF_Font_Style, 'sans' ); ?>><?php esc_html_e( 'Sans', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('sans-serif'); ?>" <?php selected( $SLGF_Font_Style, 'sans-serif' ); ?>><?php esc_html_e( 'Sans-Serif', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    <option value="<?php echo esc_attr('Tahoma'); ?>" <?php selected( $SLGF_Font_Style, 'Tahoma' ); ?>><?php esc_html_e( 'Tahoma', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                    ...
                    <option value="<?php echo esc_attr('Trebuchet MS'); ?>" <?php selected( $SLGF_Font_Style, 'Trebuchet MS' ); ?>><?php esc_html_e( 'Trebuchet MS', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?>
                    </option>
                    <option value="<?php echo esc_attr('Verdana'); ?>" <?php selected( $SLGF_Font_Style, 'Verdana' ); ?>><?php esc_html_e( 'Verdana', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?></option>
                </optgroup>
            </select>
